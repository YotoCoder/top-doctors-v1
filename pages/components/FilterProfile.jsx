...
const sortOptions = [
  ...
  { name: 'Mejor Puntuacion', href: '#', current: false },
  { name: 'Nuevos', href: '#', current: false },
  { name: 'Precio: Mas bajo', href: '#', current: false },
  { name: 'Precio: Mas alto', href: '#', current: false },
]
const subCategories = [
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-2">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex pl-3 justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    Ordenar
                    <ChevronDownIcon
          ...
          <section aria-labelledby="products-heading" className="pb-2 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-0">
              {/* Filters */}
